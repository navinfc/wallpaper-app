...
const ImageScreen = () => {
  ...
  const getSize = () => {
    ...
    console.log("height: ", calculatedHeight,  "width: ", calculatedWidth, "aspectRatio: ", aspectRatio);
  ...
  const handleDownloadImage = async () => {
    ...
    let uri = await saveFileToGallery(imageUrl, filePath);
  ...
  const saveFileToGallery = async (imageUrl, filePath) => {
    //Download file
    ...
    try {
      ...
      if (asset === null) {
        console.log('File saved to gallery successfully!');
        return uri;
      } else {
        console.log('File saved to gallery:', asset);
      }
    } catch (error) {
  ...
  return (
    <BlurView style={styles.container} tint="dark" intensity={120}>
      <View style={getSize()}>
              ...
              status === "downloading" ? (
                <View style={styles.button}>
                  ...
                  <Pressable style={styles.button}>
                    <Octicons name="download" size={24} color="white" onPress={handleDownloadImage}/>
                  </Pressable>
              )
            }
          </Animated.View>
          <Animated.View entering={FadeInDown.springify().delay(200)}>
          {
              status === "sharing" ? (
                <View style={styles.button}>
                  ...
                  <Pressable style={styles.button}>
                    <Entypo name="share" size={22} color="white" onPress={handleShareImage}/>
                  </Pressable>
              )
          }
          </Animated.View>
